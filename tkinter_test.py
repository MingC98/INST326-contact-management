...
def displayContact ():
    ...
    label3 = tk.Label(root, text= 'The number of ' + x1 + ' is:',font=('helvetica', 10))
    canvas1.create_window(200, 210, window=label3)
    
    label4 = tk.Label(root, text= x2,font=('helvetica', 10, 'bold'))
    canvas1.create_window(200, 230, window=label4)
    
button1 = tk.Button(text='Get the Square Root', command=displayContact, bg='brown', fg='white', font=('helvetica', 9, 'bold'))
